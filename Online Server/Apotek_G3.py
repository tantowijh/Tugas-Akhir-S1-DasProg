...
def header_anggota(x, y):
    ...
    print("     _    _   _  ____  ____  ___ _____  _     ".center(spasi))
    print("    / \  | \ | |/ ___|/ ___|/ _ \_   _|/ \    ".center(spasi))
    print("   / _ \ |  \| | |  _| |  _| | | || | / _ \   ".center(spasi))
    print("  / ___ \| |\  | |_| | |_| | |_| || |/ ___ \  ".center(spasi))
    print(" /_/   \_\_| \_|\____|\____|\___/ |_/_/   \_\ ".center(spasi))
    print("                                              ".center(spasi))
    print(y.center(spasi))
    print(garis1)
...
def header(x):
    ...
    print('{}{}'.format("Telp. 0888-8703-809".center(spasi),hitam+nl+garis1))
    print(waktu().center(spasi)+nl)
